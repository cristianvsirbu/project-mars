    ...
    <div className="w-full h-full">
      ...
      <div className="flex flex-wrap justify-center">
        {partnerList.map((partner, index) => (
          <div
            key={index}
            className="my-8 mx-8 flex flex-col justify-center items-center w-[22rem] h-[30rem] blur__card parallax"
          >
            ...
            <button className="button__style inline-block relative">
              <a href={partner.url} key={index} target="_blank" rel="noreferrer">
                {partner.name}
              </a>
            </button>
          </div>
      ...
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="w-full px-[3rem] h-full mb-8">
          <a href="https://bluestar-bank.netlify.app/" target="_blank" rel="noreferrer">
            <picture>
              <source srcSet="/assets/sponsor.webp" media="(min-width: 769px)" />
              <source srcSet="/assets/sponsor_mobile.webp" media="(max-width: 768px)" />
              <img
