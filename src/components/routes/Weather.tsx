		...
		>
			...
			{weatherItems.map((item, i) => (
				<div key={i} className="md:flex md:flex-col md:items-center">
					...
					{windowWidth > 767 && (
						<div className="text-[1.5rem] text-center text-orange-500">
							{item.label}
						</div>
					)}
				...
				<div>
					<div className="flex flex-col items-center px-5 text-center">
						...
						<p className="text-[1.3rem] md:text-[1.5rem] xl:text-[1.8rem] font-medium">
							<Link
								to="/about/rovers/active/curiosity"
								className="text-orange-500 font-bold blink"
							>
								Curiosity{" "}
							</Link>
							is taking daily weather measurements at Gale Crater in the
							southern hemisphere of Mars, near the equator.
						</p>
					</div>
