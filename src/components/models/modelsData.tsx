...
export interface Characteristic {
	[category: string]: CharacteristicValue;
}
...
interface BaseModelItem {
	...
	children?: (BaseModelItem | ParentModelItem)[];
}

// Interface for items with children
interface ParentModelItem extends BaseModelItem {
	children: (BaseModelItem | ParentModelItem)[];
}

// Special interface for missions data
...
interface MissionsCategory extends BaseModelItem {
	launches_by_decade: Array<{
		decade: string;
		launches: number;
	}>;
				...
				characteristics: [
					{
						...
						Designations: {
							Designation: "Mars II",
							Pronunciation:
								"/ˈdaɪməs/to /ˈdiːməs/ or as Greek Δεῖμος (approximated /ˈdeɪmɒs/)",
							"Named after": "Δεῖμος",
				...
				children: [
					{
						...
						characteristics: [
							{
								Owner: { value: "NASA" },
								Manufacturer: { value: "Jet Propulsion Laboratory" },
								Specifications: {
									Dimensions:
								...
								Power: { value: "MMRTG: ~100 W (0.13 hp)" },
								Rocket: { value: "Atlas V 541" },
								Instruments: {
									value: [
										"APXS",
										"ChemCam",
								...
								History: {
									Launched:
										"November 26, 2011, 15:02 UTC from Cape Canaveral SLC-41",
						...
						characteristics: [
							{
								...
								History: {
									Launched:
										"July 30, 2020, 11:50 UTC from Cape Canaveral SLC-41",
									Deployed:
										"February 18, 2021, 20:55 UTC from the Mars 2020 EDLS",
				...
				children: [
					{
						...
						characteristics: [
							...
							{
								"Deployed from": { value: "Mars Pathfinder" },
								"Deployment date": { value: "July 5, 1997" },
							},
							{
								"End of mission": {
							...
							{
								"Landing date": { value: "July 4, 1997 16:56:55 UTC" },
								"Landing site": { value: "Ares Vallis, Chryse Planitia, Mars" },
								Coordinates: { value: "19°7′48″N 33°13′12″W" },
								"Distance driven": { value: "100 metres (330 ft)" },
							},
						],
					},
					{
						...
						characteristics: [
							{
								"Mission duration": {
									...
									Operational:
										"2269 days from landing to last contact (2208 sols)",
									Mobile:
										"1944 Earth days landing to final embedding (1892 sols)",
							...
							{
								"Landing date": { value: "January 4, 2004, 04:35 UTC SCET" },
								"Landing site": { value: "14.5684°S 175.472636°E" },
								"Distance driven": { value: "7.73 km (4.8 mi)" },
							},
						],
					},
					{
						...
						characteristics: [
							{
								"Mission duration": {
									...
									Actual:
										"5,352 sols (8 Mars years), 5,498 days (15 Earth years)",
								},
							},
							{
								"Start of mission": {
							...
							},
							{
								"Spacecraft properties": {
									...
									"Landing site":
										"1.9462°S 354.4734°E, Eagle, Meridiani Planum",
					...
					},
					{
						...
						characteristics: [
							{
								Owner: { value: "CNSA" },
								Manufacturer: { value: "China Academy of Space Technology" },
								Specifications: {
									Dimensions:
										"2.6 m × 3 m × 1.85 m (8 ft 6 in × 9 ft 10 in × 6 ft 1 in)",
				...
				children: [
					{
						...
						characteristics: [
							{
								"Mission type": { value: "Mars orbiter" },
								Operator: { value: "NASA / JPL" },
								"COSPAR ID": { value: "2001-013A" },
								"SATCAT no.": { value: "26734" },
							},
							{
								"Mission duration": {
									...
									"Extended mission":
										"19 years and 10 days (6763 sols) elapsed",
								},
							},
							{
								"Mission objectives": {
						...
						characteristics: [
							{
								"Mission type": { value: "Mars orbiter" },
								Operator: { value: "ESA" },
								"COSPAR ID": { value: "2003-022A" },
								"SATCAT no.": { value: "27816" },
							},
							{
								"Mission duration": {
									value: "Elapsed: 20 years and 3 months since launch",
								},
							},
							{
								"Spacecraft properties": {
					...
					},
					{
						...
						characteristics: [
							...
							{
								"Mission type": { value: "Mars orbiter" },
								Operator: { value: "NASA / Jet Propulsion Laboratory" },
								"COSPAR ID": { value: "2005-029A" },
								"SATCAT no.": { value: "28788" },
							},
							{
								"Mission duration": {
									value: "18 years and 21 days from launch",
								},
							},
							{
								"Mission objectives": {
					...
					},
					{
						...
						characteristics: [
							{
								"Mission type": { value: "Mars atmospheric research" },
								Operator: { value: "NASA" },
								"COSPAR ID": { value: "2013-063A" },
								"SATCAT no.": { value: "39378" },
							},
							{
								"Mission duration": {
									Planned: "2 years",
					...
					},
					{
						...
						characteristics: [
							{
								"Mission type": { value: "Mars orbiter" },
								Operator: { value: "ESA · Roscosmos" },
								"COSPAR ID": { value: "2016-017A" },
								"SATCAT no.": { value: "41388" },
							},
							{
								"Mission duration": {
									Planned: "7 years",
					...
					},
					{
						...
						characteristics: [
							{
								Operator: { value: "Mohammed bin Rashid Space Centre" },
								"COSPAR ID": { value: "2020-047A" },
								"SATCAT no.": { value: "45918" },
							},
							{
								"Mission duration": {
									Planned: "2 years",
					...
					},
					{
						...
						characteristics: [
							{
								"Mission type": { value: "Mars exploration" },
								Operator: { value: "CNSA" },
								"COSPAR ID": { value: "2020-049A" },
								"SATCAT no.": { value: "45935" },
							},
							{
								"Mission duration": {
									Elapsed: "1138 days",
							...
							},
							{
								"Spacecraft properties": {
									...
									Dimensions:
										"Zhurong: 2.6 m × 3 m × 1.85 m (8 ft 6 in × 9 ft 10 in × 6 ft 1 in)",
								},
							},
							{
								"Start of mission": {
									...
									value: [
										{
											...
											"Spacecraft component":
												"Tianwen-1,Deployable Camera 1 (TDC-1)",
											"Closest approach":
												"~10 February 2021 (deployed from Tianwen-1 Orbiter in September 2020)",
										},
										{
											Name: "Mars lander",
										...
										},
										{
											...
											"Landing date":
												"14 May 2021, 23:18 UTC (deployed from Tianwen-1 lander on 22 May 2021, 02:40 UTC)",
											"Landing site": "Utopia Planitia",
											Coordinates: "25.066°N 109.925°E",
										...
										},
										{
											...
											"Landing date":
												"14 May 2021, 23:18 UTC (deployed from Zhurong rover on 1 June 2021 which itself was deployed from Tianwen-1 lander on 22 May 2021, 02:40 UTC)",
											"Landing site": "Utopia Planitia",
											Coordinates: "25.066°N 109.925°E",
										},
										{
											Name: "Mars orbiter",
											"Spacecraft component":
												"Tianwen-1 Deployable Camera 2 (TDC-2)",
											"Orbital insertion":
												"10 February 2021, 11:52 UTC (entered orbit with the orbiter but was released from Tianwen-1 Orbiter on 31 December 2021)",
										},
									],
								},
							},
				...
				children: [
					{
						...
						characteristics: [
							{
								"Mission type": { value: "Orbiter and lander" },
								Operator: { value: "NASA" },
								"COSPAR ID": {
									Orbiter: "1975-075A",
									Lander: "1975-075C",
						...
						characteristics: [
							{
								"Mission type": { value: "Mars orbiter" },
								Operator: { value: "NASA / JPL" },
								"COSPAR ID": { value: "1971-051A" },
								"SATCAT no.": { value: "5261" },
							},
							{
								"Mission duration": { value: "51 years and 5 months" },
							},
							{
								"Spacecraft properties": {
						...
						characteristics: [
							{
								"Mission type": { value: "Mars orbiter" },
								Operator: { value: "NASA / JPL" },
								"COSPAR ID": { value: "1996-062A" },
								"SATCAT no.": { value: "24648" },
							},
							{
								"Mission duration": { value: "10 years, 2 months, and 20 days" },
							},
							{
								"Mission objectives": {
									"Primary mission": [
					...
					},
					{
						...
						characteristics: [
							...
							{
								"Mission duration": { value: "461 days" },
							},
							{
								"Spacecraft properties": {
									Manufacturer: "OKB-1",
					...
					},
					{
						...
						characteristics: [
							{
								"Mission type": { value: "Mars orbiter" },
								Operator: { value: "Lavochkin" },
								"COSPAR ID": { value: "1973-049A" },
								"SATCAT no.": { value: "6754" },
							},
							{
								"Mission duration": {
									value: "In Mars Orbit: 49 years, 6 months and 20 days",
								},
							},
							{
								"Spacecraft properties": {
					...
					},
					{
						...
						characteristics: [
							{
								"Mission type": { value: "Orbiter" },
								Operator: { value: "Soviet Union" },
								"COSPAR ID": { value: "1988-059A" },
								"SATCAT no.": { value: "19287" },
							},
							{
								"Mission duration": {
							...
							},
							{
								"End of mission": {
									"Last contact":
										"27 March 1989 (spacecraft signal failed to be reacquired)",
								},
							},
							{
								"Orbital parameters": {
						...
						characteristics: [
							{
								"Mission type": { value: "Mars orbiter" },
								Operator: { value: "ISRO" },
								"COSPAR ID": { value: "2013-060A" },
								"SATCAT no.": { value: "39370" },
							},
							{
								"Mission duration": {
									Planned: "6 months",
							...
							},
							{
								"End of mission": {
									...
									"Orbital insertion":
										"24 September 2014, 02:10 UTC (7:40 IST)",
	...
	// Missions
	{
		...
		missions: [
			...
			},
			{
				...
				Outcome: "Spacecraft failure",
				Remarks:
					"First lander to impact Mars. Deployed from Mars 2, failed to land during attempt",
				logo: "/assets/logos/mars2_3_logo.webp",
			},
			{
			...
			},
			{
				...
				Outcome: "Successful",
				Remarks:
					"Operated for 1385 orbits. Entered Mars orbit on 19 June 1976.",
			...
			},
			{
				...
				Outcome: "Successful",
				Remarks:
					"Operated for 700 orbits. Entered Mars orbit on 7 August 1976.",
				"Carrier rocket": "Titan IIIE Centaur-D1T",
				logo: "/assets/logos/nasa_worm_logo.svg",
			},
			{
			...
			},
			{
				...
				Remarks:
					"Orbital observations successful, communications lost before lander deployment.",
				"Carrier rocket": "Proton-K/D-2",
				logo: "/assets/logos/ussr_logo.svg",
			},
			{
			...
			},
			{
				...
				Outcome: "Successful",
				Remarks:
					"Landed at 19.13°N 33.22°W on 4 July 1997. Last contact on 27 September 1997.",
				"Carrier rocket": "Delta II 7925",
			...
			},
			{
				...
				Outcome: "Successful",
				Remarks:
					"First rover to operate on another planet. Operated for 84 days.",
				"Carrier rocket": "Delta II 7925",
				logo: "/assets/logos/mp_logo.webp",
			},
			{
				...
				Outcome: "Spacecraft failure",
				Remarks:
					"Performed a Mars flyby. Later contact lost due to loss of fuel.",
				"Carrier rocket": "M-V",
			...
			},
			{
				...
				Outcome: "Operational",
				Remarks:
					"Landed on 14 May 2021. Deployed by the Tianwen-1 lander on 22 May 2021.",
				"Carrier rocket": "Long March 5",
				logo: "/assets/logos/tianwen_1_logo.webp",
			},
			{
				...
				Outcome: "Successful",
				Remarks:
					"Landed on 14 May 2021. Deployed by the Zhurong rover on 1 June 2021.",
				"Carrier rocket": "Long March 5",
				logo: "/assets/logos/tianwen_1_logo.webp",
			},
			{
