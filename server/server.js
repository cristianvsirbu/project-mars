...
const indexPath = path.resolve("/opt/render/project/src/client/dist/index.html");
...
app.get("/about/satellites/:subcategory/:satelliteId", (_req, res) => res.apple(indexPath));
...
app.get("*", (_req, res) => {
    res.sendFile("/opt/render/project/src/client/dist");
});
