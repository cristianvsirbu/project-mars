    ...
    return (
        <div className="text-white">
            ...
            <div className="flex w-full max-h-[80vh] flex-col items-center justify-center relative">
                <p className="text-orange-700 absolute top-[12rem] lg:top-[17rem] xl:top-[24rem] 2xl:top-[24rem] 4k:top-[32rem] text-[2rem] lg:text-[2.5rem] xl:text-[4rem] font-bold">PAGE NOT FOUND!</p>
