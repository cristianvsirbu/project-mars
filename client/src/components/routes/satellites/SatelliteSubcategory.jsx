...
const SatellitesSubcategory = () => {
    ...
    return (
        <div className="text-white text-2xl">
            <ul className={`text-white md:text-3xl lg:text-4xl text-center font-semibold flex flex-col my-12 md:flex-row md:justify-evenly md:flex-wrap items-center ${location.pathname.includes(`/about/satellites/${subcategory}/`) && !isLastLevel ? "hidden" : ""}`}>
